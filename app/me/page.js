...
export default function Me() {
  ...
  const inputStyle = {
    display: "block", width: "100%", padding: "12px 14px", margin: "8px 0 14px",
    borderRadius: 10, border: "1px solid rgba(255,255,255,0.18)",
    background: "rgba(255,255,255,0.06)", color: "#eaf8eb", boxSizing: "border-box",
  };
  const button = {
    padding: "10px 16px", borderRadius: 10, border: "1px solid rgba(255,255,255,0.18)",
    background: "rgba(87,214,127,0.22)", color: "#eaf8eb", cursor: "pointer",
  };
  ...
  async function copyReferral() {
    ...
    try { await navigator.clipboard.writeText(rec.referral_code); setCopyMsg("Copied ✓"); }
          ...
          <>
            ...
            {rec.referral_code && (
              <p style={{display:"flex",alignItems:"center",gap:10}}>
                ...
                <button type="button" onClick={copyReferral} style={{...button, padding:"6px 10px"}}>Copy</button>
