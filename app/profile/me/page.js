...
export default function Me() {
  ...
  async function saveWallet(e) {
    ...
    setSaving(false);
    if (!r.ok) {
      setSaveMsg(j.error || "Failed to update wallet");
      return;
    }
  ...
  return (
    <main>
      <Card>
        <h1 style={{ marginTop: 0 }}>Your Farmer profile</h1>
        ...
        {rec && (
          <>
            <p>
              <strong>Wallet:</strong> {rec.wallet_address}
            </p>
            <p>
              <strong>Tier:</strong> {rec.tier}
            </p>
